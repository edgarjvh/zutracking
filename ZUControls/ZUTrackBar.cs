...
namespace XComponent.SliderBar
{
    ...
    /// <summary>
    ///	  <para>
    ///		ZUTrackBar represents an advanced track bar that is very better than the 
    ///		standard trackbar.
    ///   </para>
    ///   <para>
    ///   ZUTrackBar supports the following features:
    ///   <list type="bullet">
    ...
    ///     <item><c>You can change <see cref="ZUTrackBar.TickColor"/>, <see cref="ZUTrackBar.TickFrequency"/>, <see cref="ZUTrackBar.TickHeight"/>.</c></item> 
    ///     <item><c>You can change <see cref="ZUTrackBar.TrackerColor"/> and <see cref="ZUTrackBar.TrackerSize"/>.</c></item> 
    ///     <item><c>You can change <see cref="ZUTrackBar.TrackLineColor"/> and <see cref="ZUTrackBar.TrackLineHeight"/>.</c></item> 	
    ...
    ///   </para>
    /// </summary>
    [Description("ZUTrackBar represents an advanced track bar that is very better than the standard trackbar.")]
    [ToolboxBitmap(typeof(ZUTrackBar), "Editors.ZUTrackBar.ZUTrackBar.bmp")]
    [Designer(typeof(ZUTrackBarDesigner))]
    [DefaultProperty("Maximum")]
    [DefaultEvent("ValueChanged")]
    public class ZUTrackBar : System.Windows.Forms.Control
    {
        ...
        /// <summary>
        /// Constructor method of <see cref="ZUTrackBar"/> class
        /// </summary>
        public ZUTrackBar()
        {
        ...
        /// </summary>
        /// <remarks>
        /// For a <see cref="ZUTrackBar"/> with a large range of values between the <see cref="Minimum"/> and the 
        ...
        [Description("The current value for the ZUTrackBar, in the range specified by the Minimum and Maximum properties.")]
        [Category("Behavior")]
        public int Value
        {
            get
        ...
        /// <summary>
        /// Gets or sets the lower limit of the range this <see cref="ZUTrackBar"/> is working with.
        /// </summary>
        ...
        /// <value>The minimum value for the <see cref="ZUTrackBar"/>. The default value is 0.</value>
        [Description("The lower bound of the range this ZUTrackBar is working with.")]
        [Category("Behavior")]
        public int Minimum
        {
            get
        ...
        /// <summary>
        /// Gets or sets the upper limit of the range this <see cref="ZUTrackBar"/> is working with.
        /// </summary>
        /// <remarks>You can use the <see cref="SetRange"/> method to set both the <see cref="Maximum"/> and <see cref="Minimum"/> properties at the same time.</remarks>
        /// <value>The maximum value for the <see cref="ZUTrackBar"/>. The default value is 10.</value>
        [Description("The uppper bound of the range this ZUTrackBar is working with.")]
        [Category("Behavior")]
        public int Maximum
        {
            get
